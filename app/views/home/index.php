            ...
            <div class="col-lg-8">
                <div class="box h-100">
                    <div class="d-flex align-items-center">
                        <div class="img"><img src="<?= ROOT ?>app/public/site/images/img_1.jpg" class="img-fluid" alt="Image"></div>
                        <div class="text">
            ...
            <div class="col-lg-4">
                <div class="box small h-100">
                    <div class="d-flex align-items-center mb-2">
                        <div class="img"><img src="<?= ROOT ?>app/public/site/images/img_2.jpg" class="img-fluid" alt="Image"></div>
                        <div class="text">
                            <a href="#" class="category">Tutorial</a>
                            <h3><a href="#">Learning React Native</a></h3>
                        </div>
                    ...
                    <div class="d-flex align-items-center mb-2">
                        <div class="img"><img src="<?= ROOT ?>app/public/site/images/img_3.jpg" class="img-fluid" alt="Image"></div>
                        <div class="text">
                            <a href="#" class="category">Tutorial</a>
                            <h3><a href="#">Learning React Native</a></h3>
                        </div>
                    ...
                    <div class="d-flex align-items-center">
                        <div class="img"><img src="<?= ROOT ?>app/public/site/images/img_4.jpg" class="img-fluid" alt="Image"></div>
                        <div class="text">
                            <a href="#" class="category">Tutorial</a>
                            <h3><a href="#">Learning React Native</a></h3>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="d-flex tutorial-item mb-4">
                    <div class="img-wrap">
                        <a href="#"><img src="<?= ROOT ?>app/public/site/images/img_1.jpg" alt="Image" class="img-fluid"></a>
                    </div>
                    <div>
                        <h3><a href="#">Learning React Native</a></h3>
                ...
                <div class="d-flex tutorial-item mb-4">
                    <div class="img-wrap">
                        <a href="#"><img src="<?= ROOT ?>app/public/site/images/img_2.jpg" alt="Image" class="img-fluid"></a>
                    </div>
                    <div>
                ...
                <div class="d-flex tutorial-item mb-4">
                    <div class="img-wrap">
                        <a href="#"><img src="<?= ROOT ?>app/public/site/images/img_3.jpg" alt="Image" class="img-fluid"></a>
                    </div>
                    <div>
                ...
                <div class="d-flex tutorial-item mb-4">
                    <div class="img-wrap">
                        <a href="#"><img src="<?= ROOT ?>app/public/site/images/img_4.jpg" alt="Image" class="img-fluid"></a>
                    </div>
                    <div>
        ...
        <div class="row">
            <div class="col-lg-4 mb-4 mb-lg-0">
                <div class="testimonial-2">
                    ...
                    <div class="d-flex v-card align-items-center">
                        <img src="<?= ROOT ?>app/public/site/images/person_1.jpg" alt="Image" class="img-fluid mr-3">
            ...
            <div class="col-lg-4 mb-4 mb-lg-0">
                <div class="testimonial-2">
                    ...
                    <div class="d-flex v-card align-items-center">
                        <img src="<?= ROOT ?>app/public/site/images/person_2.jpg" alt="Image" class="img-fluid mr-3">
                        <div class="author-name">
            ...
            <div class="col-lg-4 mb-4 mb-lg-0">
                <div class="testimonial-2">
                    ...
                    <div class="d-flex v-card align-items-center">
                        <img src="<?= ROOT ?>app/public/site/images/person_3.jpg" alt="Image" class="img-fluid mr-3">
                        <div class="author-name">
